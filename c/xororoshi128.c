...
void next() {
	...
	y = REV(s[0] + s[1]);
	//y = REV(s[1] + s0);
#include "xororoshi128-next.c"
#elif defined(STAR2) || defined(STAR8) || defined(STAR32)
#include "xororoshi128-next.c"
	y = REV(s[1] * M);
#else
#include "xororoshi128-next.c"
